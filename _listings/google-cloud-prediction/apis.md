...
- name: Google Cloud Prediction API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-cloud-prediction/master/_listings/google-cloud-prediction/project-trainedmodels-id-predict-post.md
x-common:
- type: x-bugs
